...
public class Clase {
    ...
    private String palabras[] = {"oso", "papa", "murcielago", "parangaricutirimicuaro", "otorrinolaringologo", "feliz", ""};
    ...
    public void imgError(int nivel, String letra){
        ...
        for(int vc=0; vc<longPalabra-1; vc++){ 
            carc=palabra.substring(vc, vc+1);
            carc2=palabra.substring((longPalabra-1)-vc, longPalabra-vc);
        ...
        switch(e){
            case 0:
                imgEr="/Ventana/e0.jpg";  
            break;
            case 1:
                imgEr="/Ventana/e1.jpg";
            break;
            case 2:
                imgEr="/Ventana/e2.jpg";
            break;
            case 3:
                imgEr="/Ventana/e3.jpg";
            break;
            case 4:
                imgEr="/Ventana/e4.jpg";
            break;
            case 5:
                imgEr="/Ventana/e5.jpg";
            break;
            default:
